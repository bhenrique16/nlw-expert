...
export function NewNoteCard({ onNoteCreated }: NewNoteCardProps) {
    ...
    function handleStartRecording() {
        ...
        const isSpeedRecognitionAPIAvailable = 'SpeechRecognition' in window
    ...
    return (
        <Dialog.Root>
            <Dialog.Trigger className=" bg-slate-700  hover:ring-slate-600  rounded-md text-left flex flex-col gap-3 p-5 space-y-3 overflow-hidden relative hover:ring-2  focus-visible:ring-2 outline-none focus-visible:ring-lime-400">
